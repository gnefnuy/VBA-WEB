...
' 利用 Microsoft 的下一代加密 （CNG） API 进行新式哈希和加密/解密,之前的MyCrypto.cls 可能过时了
'
' (c) Gustav Brock, Cactus Data ApS, CPH
' https://github.com/GustavBrock/VBA.Cryptography
' 参考
' https://www.experts-exchange.com/articles/37111/Utilise-Microsoft's-Next-Generation-Cryptography-CNG-API-in-VBA.html
'
' Credit:
'
